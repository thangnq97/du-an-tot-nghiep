...
class ContractUserController extends Controller
{
    public function index(string $id) {
        ...
        return view('user.contract.index', compact('title', 'sub_title', 'room', 'contract', 'contract_extension'));
    }
    ...
    public function createExtensionContract(string $room_id) {
        ...
        return view('user.contract.extension', compact('title', 'sub_title', 'room'));
    }
}